...
const MEETING_TYPES: MeetingTypeDisplay[] = [
  ...
  { name: 'Team', color: '#4caf50', hits: 2, effect: 'Split ball', minWeek: 4 },
  { name: 'Boss', color: '#e53935', hits: 3, effect: 'Speed x1.8!', minWeek: 6 },
  { name: 'Lunch', color: '#fbc02d', hits: 1, effect: 'Normalize speed', minWeek: 3 },
  { name: 'Personal', color: '#8e24aa', hits: 1, effect: 'Reset bounce' },
  { name: 'Sticky', color: '#9E9E9E', hits: 1, effect: 'Ball sticks 0.5s', minWeek: 8 },
  // New types
  { name: 'Recurring', color: '#2e7d32', hits: 2, effect: 'Spawns follow-up', minWeek: 13 },
  { name: 'All-Hands', color: '#ff6d00', hits: 5, effect: 'Damages adjacent', minWeek: 18 },
  { name: 'Focus', color: '#00897b', hits: 1, effect: '+50% score 5s', minWeek: 10 },
  { name: 'Emergency', color: '#d32f2f', hits: 2, effect: '8s timer!', minWeek: 21 },
  { name: 'Optional', color: '#78909c', hits: 1, effect: '3x points', minWeek: 9 },
];
